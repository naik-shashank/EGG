...
const AddNewOutlet = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      'https://egg-8v9i.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner'
    )
      .then((response) => response.json())
      .then((data) => {
        if (data.status === 'success') {
    ...
    fetch(
      'https://egg-8v9i.onrender.com/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner'
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('https://egg-8v9i.onrender.com/egg-bucket-b2b/create-outlet', {
      method: 'POST',
      body: formDataToSend,
    })
      .then((response) => response.json())
