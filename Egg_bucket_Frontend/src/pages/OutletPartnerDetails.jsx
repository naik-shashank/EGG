...
const OutletPartnerDetails = () => {
  ...
  const fetchOutlets = async () => {
    try {
      const response = await fetch('http://egg-8v9i.onrender.com/egg-bucket-b2b/get-all-outlets');
  ...
  const fetchOutletPartners = async (query = '') => {
    try {
      const response = await fetch('http://egg-8v9i.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner' + query);
      const data = await response.json();
  ...
  const handleSaveEdit = async (formData) => {
    try {
      ...
      const response = await fetch(`http://egg-8v9i.onrender.com/outletPartners/egg-bucket-b2b/outlet_partner/${editingOutletPartner._id}`, {
        method: 'PATCH',
        body: formData
      });
      const data = await response.json();
  ...
  const handleDeleteClick = async (partnerId) => {
    ...
    if (confirmDelete) {
      ...
      try {
        const response = await fetch(`http://egg-8v9i.onrender.com/outletPartners/egg-bucket-b2b/outlet_partner/${partnerId}`, {
          method: 'DELETE'
        });
