...
const OrderDetails = () => {
    ...
    const fetchOutlets = async () => {
      try {
        const response = await fetch(
          "http://egg-8v9i.onrender.com/egg-bucket-b2b/get-all-outlets"
        );
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const response = await fetch(
          "http://egg-8v9i.onrender.com/customers/egg-bucket-b2b/getAllCustomer"
        );
        const data = await response.json();
        if (data) {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch(
          "http://egg-8v9i.onrender.com/orders/egg-bucket-b2b/getAllOrder"
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchFilteredOrders = async () => {
      let url = "http://egg-8v9i.onrender.com/orders/egg-bucket-b2b/getAllOrder";
      const filters = [];
