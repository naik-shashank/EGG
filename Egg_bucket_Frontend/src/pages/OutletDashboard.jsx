...
const OutletDashboard = () => {
  ...
  useEffect(() => {
    const fetchOutlets = async () => {
      try {
        const response = await axios.get('http://egg-8v9i.onrender.com/egg-bucket-b2b/get-all-outlets');
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const response = await axios.get('http://egg-8v9i.onrender.com/customers/egg-bucket-b2b/getAllCustomer');
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      let url = 'http://egg-8v9i.onrender.com/admin/egg-bucket-b2b/dashboard';
      const filters = [];
